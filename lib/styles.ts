...
const headlines = css({
  ...
  "h1": apply
    `text-2xl leading-7 sm:text-3xl ${styles.text.primaryGradientAccent}`,
  "h2": apply
    `text-xl leading-6 sm:text-2xl mb-4 ${styles.text.secondaryGradientAccent}`,
  "h3": apply
    `text-lg leading-5 sm:text-xl mb-3 ${styles.text.secondaryGradientAccent}`,
  "h4": apply
    `text-base leading-4 sm:text-lg ${styles.text.secondaryGradientAccent}`,
  "h5": apply
    `text-sm leading-3 sm:text-base ${styles.text.secondaryGradientAccent}`,
});
